(function () {
  ...
  const translations = {
    ru: {
      ...
      'pricing.card1.benefit': 'Экономия 170 000 сум (настройка со скидкой 50%)',
      'pricing.card2.name': 'Комфорт',
      'pricing.card2.period': '6 месяцев',
      'pricing.card2.benefit': 'Экономия 350 000 сум (запуск и настройка — 0 сум + 1 месяц обслуживания в подарок)',
      'pricing.card3.name': 'Премиум',
      'pricing.card3.period': '12 месяцев',
      'pricing.card3.benefit': 'Экономия 710 000 сум (запуск — бесплатно + 2 месяца в подарок)',
